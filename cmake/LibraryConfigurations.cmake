...
if (${PLATFORM} STREQUAL "Desktop")
    ...
    elseif (WIN32)
        ...
        if (${OPENGL_VERSION} MATCHES "Daxa")
            set(GRAPHICS "GRAPHICS_API_DAXA")
            set(RAYLIB_USE_DAXA TRUE)
...
if (NOT ${OPENGL_VERSION} MATCHES "OFF")
    ...
    elseif (${OPENGL_VERSION} MATCHES "Software")
        set(GRAPHICS "GRAPHICS_API_OPENGL_SOFTWARE")
    elseif (${OPENGL_VERSION} MATCHES "Daxa")
        if (NOT WIN32)
            message(FATAL_ERROR "The experimental Daxa backend currently supports only PLATFORM=Win32 or Windows desktop builds.")
        endif ()
        set(GRAPHICS "GRAPHICS_API_DAXA")
        set(RAYLIB_USE_DAXA TRUE)
    endif ()
